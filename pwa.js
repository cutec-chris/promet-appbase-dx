...
rtl.module("pwa_helper",["System","Classes","SysUtils"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass($mod,"TPWAUpdater",pas.System.TObject,function () {
    this.Create$1 = function (Files) {
    };
  });
});
rtl.module("program",["System","JS","pwa_helper"],function () {
  "use strict";
  var $mod = this;
  this.Updater = null;
  this.precacheFiles = ["index.html",".\/","index.css","manifest.json","appbase\/appbase.js","appbase\/startpage.js","appbase\/dhtmlx\/dhtmlx.js","appbase\/dhtmlx\/dhtmlx.css","appbase\/dhtmlx\/fonts\/font_awesome\/css\/font-awesome.min.css","appbase\/images\/world_icon144.png","appbase\/images\/world_icon192.png"];
  $mod.$main = function () {
    $mod.Updater = pas.pwa_helper.TPWAUpdater.$create("Create$1",[$mod.precacheFiles]);
  };
});
